...
never holds a spec whose status lies. A task that crosses the spec threshold — 100 lines or more,
or enforcement semantics, or a public contract — may not be claimed until the spec it names is
`accepted`. See `.agents/skills/tasks`.
